...
contract StakedTokenAuctionHouse {
    ...
    **/
    ...
    function startAuction(
        ...
        emit StartAuction(id, auctionsStarted, amountToSell, accountingEngine, bids[id].auctionDeadline, activeStakedTokenAuctions);
    }
    /**
    ...
    function settleAuction(uint256 id) external {
        ...
        require(bids[id].bidExpiry != 0 && (bids[id].bidExpiry < now || bids[id].auctionDeadline < now), "StakedTokenAuctionHouse/not-finished");
